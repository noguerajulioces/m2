...
class FaqsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create faq' do
    assert_difference('Faq.count') do
      post faqs_url, params: { faq: { active: @faq.active, answer: @faq.answer, question: @faq.question } }
    end
  ...
  test 'should update faq' do
    patch faq_url(@faq), params: { faq: { active: @faq.active, answer: @faq.answer, question: @faq.question } }
